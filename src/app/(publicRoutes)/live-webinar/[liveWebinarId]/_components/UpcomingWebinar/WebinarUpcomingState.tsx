    ...
    <div className="w-full min-h-screen mx-auto max-w-[400px] flex flex-col justify-center items-center gap-8 py-20">
      <div className="space-y-6">
        <p className="text-3xl font-semibold text-primary text-center">
          Seems link you are a little early
        </p>
        <CountdownTimer
                ...
                webinar?.webinarStatus === WebinarStatus.WAITING_ROOM ? (
                    <>
                        {currentUser?.id === webinar?.presenterId ? (
                            <Button className="w-full max-w-[300px] font-semibold" onClick={handleStartWebinar} disabled={loading}>
                                {loading? (
                                    <>
                            ...
                            <WaitListComponent webinarId={webinar.id} webinarStatus="WAITING_ROOM" /> 
                        )}
                    </> 
