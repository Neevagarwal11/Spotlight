  ...
  return (
    <div className='space-y-8'>
        <div className='flex items-center justify-between'>
            ...
            <Switch  id='lock-chat' checked={lockChat || false} onCheckedChange={handleToggleChat} />
        </div>

        <div className='space-y-4'>
            <div className='flex items-center justify-between'>
                <div>
                <Label htmlFor='coupon-enabled' className='text-base font-medium' >Coupon Code Enabled</Label>
